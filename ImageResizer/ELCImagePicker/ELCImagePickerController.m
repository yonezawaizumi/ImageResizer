...
- (void)selectedAssets:(NSArray *)assets
{
	...
	for(ALAsset *asset in assets) {
        ...
        //add yizumi 20140101
        [workingDictionary setObject:[UIImage imageWithCGImage:[asset thumbnail]] forKey:@"thumbnail"];
        
        //add yizumi 20140102
        NSDictionary *metadata = assetRep ? [assetRep metadata] : [NSDictionary dictionaryWithObjectsAndKeys:nil];
        [workingDictionary setObject:metadata forKey:@"metadata"];
